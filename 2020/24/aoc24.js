		...
		switch (_v0) {
			case 'w':
				return A2(
					$elm$core$List$cons,
					0,
					$author$project$Main$parseTileMoves(
			...
			case 'e':
				return A2(
					...
					$author$project$Main$parseTileMoves(
						A2($elm$core$String$dropLeft, 1, s)));
			default:
				var _v1 = A2($elm$core$String$left, 2, s);
				switch (_v1) {
					case 'nw':
						return A2(
							$elm$core$List$cons,
...
var $author$project$Main$sample = 'sesenwnenenewseeswwswswwnenewsewsw\nneeenesenwnwwswnenewnwwsewnenwseswesw\nseswneswswsenwwnwse\nnwnwneseeswswnenewneswwnewseswneseene\nswweswneswnenwsewnwneneseenw\neesenwseswswnenwswnwnwsewwnwsene\nsewnenenenesenwsewnenwwwse\nwenwwweseeeweswwwnwwe\nwsweesenenewnwwnwsenewsenwwsesesenwne\nneeswseenwwswnwswswnw\nnenwswwsewswnenenewsenwsenwnesesenew\nenewnwewneswsewnwswenweswnenwsenwsw\nsweneswneswneneenwnewenewwneswswnese\nswwesenesewenwneswnwwneseswwne\nenesenwswwswneneswsenwnewswseenwsese\nwnwnesenesenenwwnenwsewesewsesesew\nnenewswnwewswnenesenwnesewesw\neneswnwswnwsenenwnwnwwseeswneewsenese\nneswnwewnwnwseenwseesewsenwsweewe\nwseweeenwnesenwwwswnew';
var $author$project$Main$initTileMovesList = function (dataSource) {
	var data = function () {
		if (dataSource === 1) {
...
var $author$project$Main$init = function (_v0) {
	var model = $author$project$Main$initModel(0);
...
var $author$project$Main$subscriptions = function (model) {
	var _v0 = model.a;
	if (!_v0.$) {
		var initializing = _v0.a;
		return initializing.f ? $elm$core$Platform$Sub$none : A2(
			$elm$time$Time$every,
			initializing.g,
			function (_v1) {
		...
		var animating = _v0.a;
		return animating.f ? $elm$core$Platform$Sub$none : A2(
			$elm$time$Time$every,
			animating.g,
			function (_v2) {
				return $author$project$Main$Tick;
...
var $author$project$Main$updateDataSource = F2(
	function (dataSource, model) {
		return $author$project$Main$initModel(dataSource);
	});
var $author$project$Main$Animating = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$updateFaster = function (model) {
	var _v0 = model.a;
	if (!_v0.$) {
		var initializing = _v0.a;
		var tickInterval = initializing.g / 2;
		return _Utils_update(
			model,
			{
				a: $author$project$Main$Initializing(
					_Utils_update(
						initializing,
						{g: tickInterval}))
			});
		...
		var animating = _v0.a;
		var tickInterval = animating.g / 2;
		return _Utils_update(
			model,
			{
				a: $author$project$Main$Animating(
					_Utils_update(
						animating,
						{g: tickInterval}))
			});
...
var $author$project$Main$updateRestart = function (model) {
	...
	if (!_v0.$) {
		...
		var animating = _v0.a;
		var a = $author$project$Main$initAnimating(animating.U);
		return _Utils_update(
			model,
			{
				a: $author$project$Main$Animating(a)
			});
	}
};
var $author$project$Main$updateSlower = function (model) {
	var _v0 = model.a;
	if (!_v0.$) {
		var initializing = _v0.a;
		var tickInterval = initializing.g * 2;
...
var $author$project$Main$adjacent = F2(
	function (_v0, move) {
		var a = _v0.a;
		var _v1 = _v0.b;
		var r = _v1.a;
		...
		switch (move) {
			...
			case 5:
				return _Utils_Tuple2(
					1 - a,
					_Utils_Tuple2(r + a, c + a));
			case 2:
				return _Utils_Tuple2(
					1 - a,
					_Utils_Tuple2(r + a, c - (1 - a)));
			case 0:
				return _Utils_Tuple2(
					a,
					_Utils_Tuple2(r, c - 1));
			case 1:
				return _Utils_Tuple2(
					1 - a,
					_Utils_Tuple2(r - (1 - a), c - (1 - a)));
			default:
				return _Utils_Tuple2(
					1 - a,
					_Utils_Tuple2(r - (1 - a), c + a));
		}
	});
var $author$project$Main$getAdjacentTiles = function (tile) {
	return A2(
		$elm$core$List$map,
		$author$project$Main$adjacent(tile),
		_List_fromArray(
			[3, 0, 5, 2, 4, 1]));
};
...
var $author$project$Main$becomesBlack = F2(
	function (blackTiles, tile) {
		var count = $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				function (t) {
					return A2($elm$core$Set$member, t, blackTiles);
				},
				$author$project$Main$getAdjacentTiles(tile)));
		return count === 2;
	});
...
var $author$project$Main$findWhiteTiles = function (blackTiles) {
	var neighbours = $elm$core$Set$fromList(
		A2(
			$elm$core$List$concatMap,
			$author$project$Main$getAdjacentTiles,
			$elm$core$Set$toList(blackTiles)));
	return A2($elm$core$Set$diff, neighbours, blackTiles);
};
var $author$project$Main$remainsBlack = F2(
	function (blackTiles, tile) {
		var count = $elm$core$List$length(
			A2(
				$elm$core$List$filter,
...
var $author$project$Main$evolveStep = function (blackTiles) {
	var whiteTiles = $author$project$Main$findWhiteTiles(blackTiles);
	var black2 = A2(
		$elm$core$Set$filter,
		$author$project$Main$becomesBlack(blackTiles),
		whiteTiles);
	var black1 = A2(
		$elm$core$Set$filter,
		$author$project$Main$remainsBlack(blackTiles),
		blackTiles);
	return A2($elm$core$Set$union, black1, black2);
};
var $author$project$Main$updateAnimating = function (animating) {
	var days = animating.M;
	var pause = ((days + 1) === 100) || animating.f;
	var blackTiles = $author$project$Main$evolveStep(animating.A);
	return _Utils_update(
		animating,
		{
			A: blackTiles,
...
var $author$project$Main$initTile = _Utils_Tuple2(
	0,
	_Utils_Tuple2(0, 0));
...
var $author$project$Main$toMoveStr = function (move) {
	switch (move) {
		case 3:
			return 'E';
		case 5:
...
var $author$project$Main$updateInitializing = function (initializing) {
	var _v0 = initializing.u;
	if (_v0.$ === 1) {
		var _v1 = initializing.O;
		if (!_v1.b) {
			return _Utils_update(
				initializing,
				{N: true});
		...
		var tile = _v0.a;
		var _v2 = initializing.H;
		if (!_v2.b) {
			var currentlyPlaced = initializing.y;
			var nextPlaced = A2($elm$core$Set$member, tile, currentlyPlaced) ? A2($elm$core$Set$remove, tile, currentlyPlaced) : A2($elm$core$Set$insert, tile, currentlyPlaced);
			return _Utils_update(
				initializing,
				{u: $elm$core$Maybe$Nothing, y: nextPlaced});
		} else {
			var move = _v2.a;
			var restMoves = _v2.b;
...
var $author$project$Main$updateStep = function (model) {
	...
	if (!_v0.$) {
		var initializing = _v0.a;
		if (initializing.N) {
			var blackTiles = initializing.y;
			var anim = $author$project$Main$initAnimating(blackTiles);
			return _Utils_update(
				model,
				{
					a: $author$project$Main$Animating(anim)
				});
		} else {
			return _Utils_update(
				model,
				{
					a: $author$project$Main$Initializing(
						$author$project$Main$updateInitializing(initializing))
				});
		}
	} else {
		var animating = _v0.a;
		return _Utils_update(
			...
			{
				a: $author$project$Main$Animating(
					$author$project$Main$updateAnimating(animating))
			});
	}
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				return _Utils_Tuple2(
					$author$project$Main$updateFaster(model),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					$author$project$Main$updateSlower(model),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					$author$project$Main$updateStep(model),
...
var $author$project$Main$hexSize = 3;
var $elm$core$String$fromFloat = _String_fromNumber;
var $author$project$Main$f2s = $elm$core$String$fromFloat;
var $elm$svg$Svg$Attributes$fill = _VirtualDom_attribute('fill');
var $elm$core$Basics$sqrt = _Basics_sqrt;
var $author$project$Main$getNEPoint = F2(
	function (size, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var w = size * $elm$core$Basics$sqrt(3);
		return _Utils_Tuple2(x + (w / 2), y - (size / 2));
	});
var $author$project$Main$getNPoint = F2(
	function (size, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		return _Utils_Tuple2(x, y - size);
	});
var $author$project$Main$getNWPoint = F2(
	function (size, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var w = size * $elm$core$Basics$sqrt(3);
...
var $author$project$Main$getSEPoint = F2(
	function (size, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var w = size * $elm$core$Basics$sqrt(3);
...
var $author$project$Main$getSPoint = F2(
	function (size, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		return _Utils_Tuple2(x, y + size);
	});
var $author$project$Main$getSWPoint = F2(
	function (size, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var w = size * $elm$core$Basics$sqrt(3);
...
var $author$project$Main$toHexagonElement = F3(
	function (placed, size, _v0) {
		var a = _v0.a;
		var _v1 = _v0.b;
		var r = _v1.a;
		var c = _v1.b;
		var wf = size * $elm$core$Basics$sqrt(3);
		var rf = r * wf;
		var cf = c * wf;
		var af = a * wf;
		var pos = _Utils_Tuple2(
			(af / 2) + cf,
			$elm$core$Basics$sqrt(3) * ((af / 2) + rf));
		var pts = _List_fromArray(
			[
				A2($author$project$Main$getSWPoint, size, pos),
				A2($author$project$Main$getSPoint, size, pos),
				A2($author$project$Main$getSEPoint, size, pos),
				A2($author$project$Main$getNEPoint, size, pos),
				A2($author$project$Main$getNPoint, size, pos),
				A2($author$project$Main$getNWPoint, size, pos)
			]);
		var ptsStr = function () {
			var str = function (_v2) {
				var x = _v2.a;
				var y = _v2.b;
				return $author$project$Main$f2s(x) + (',' + $author$project$Main$f2s(y));
			};
			return A2(
				$elm$core$String$join,
				' ',
...
var $author$project$Main$toAnimatingElements = function (animating) {
	return A2(
		$elm$core$List$map,
		A2($author$project$Main$toHexagonElement, true, $author$project$Main$hexSize),
		$elm$core$Set$toList(animating.A));
};
var $author$project$Main$toInitializingElements = function (initializing) {
	var placedElements = A2(
		$elm$core$List$map,
		A2($author$project$Main$toHexagonElement, true, $author$project$Main$hexSize),
		$elm$core$Set$toList(initializing.y));
	var currentTile = initializing.u;
	var currentElements = function () {
		if (currentTile.$ === 1) {
			return _List_Nil;
		} else {
			var tile = currentTile.a;
			return _List_fromArray(
				[
					A3($author$project$Main$toHexagonElement, false, $author$project$Main$hexSize, tile)
				]);
		}
	}();
	return A2($elm$core$List$append, placedElements, currentElements);
};
...
var $author$project$Main$toSvg = function (model) {
	var elements = function () {
		...
		if (!_v0.$) {
			var initializing = _v0.a;
			return $author$project$Main$toInitializingElements(initializing);
		} else {
			var animating = _v0.a;
			return $author$project$Main$toAnimatingElements(animating);
		}
	}();
	return A2(
		$elm$svg$Svg$svg,
...
var $author$project$Main$view = function (model) {
	...
	var playButtonText = function () {
		var _v2 = model.a;
		if (!_v2.$) {
			var initializing = _v2.a;
			return initializing.f ? 'Initialize' : 'Pause';
		} else {
			var animating = _v2.a;
			return animating.f ? 'Animate' : 'Pause';
		}
	}();
	...
	var count = 0;
	var blackTilesCount = function () {
		var _v0 = model.a;
		if (!_v0.$) {
			var initializing = _v0.a;
			return $elm$core$Set$size(initializing.y);
		} else {
			var animating = _v0.a;
			return $elm$core$Set$size(animating.A);
		}
	}();
	return A2(
		$elm$html$Html$table,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Day 24: Lobby Layout')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://adventofcode.com/2020/day/24')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('https://adventofcode.com/2020/day/24')
									]))
							]))
					])),
				A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$checked(model.F === 1)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$label,
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$disabled(restartDisabled)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(playButtonText)
									])),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$fromInt(blackTilesCount))
									]))
							]))
					])),
				A2(
