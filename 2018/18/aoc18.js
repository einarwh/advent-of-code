...
var $author$project$Main$defaultTickInterval = 40;
...
var $author$project$Main$deserialize = $tortus$elm_array_2d$Array2D$fromList;
...
var $author$project$Main$countAcre = F2(
	function (acres, acre) {
		return $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				function (a) {
					return _Utils_eq(a, acre);
				},
				acres));
	});
...
var $author$project$Main$getAllPositions = function (arr) {
	var ys = A2(
		$elm$core$List$range,
		0,
...
var $author$project$Main$getResourceValue = function (area) {
	var acres = A2(
		$elm$core$List$filterMap,
		function (_v0) {
			var x = _v0.a;
			var y = _v0.b;
			return A3($tortus$elm_array_2d$Array2D$get, y, x, area);
		},
		$author$project$Main$getAllPositions(area));
	var lumberyards = A2($author$project$Main$countAcre, acres, '#');
	var trees = A2($author$project$Main$countAcre, acres, '|');
...
var $author$project$Main$serialize = function (arr) {
	var ys = A2(
		$elm$core$List$range,
		0,
		$tortus$elm_array_2d$Array2D$rows(arr) - 1);
	...
	return A2(
		...
		function (y) {
			return A2(
				$elm$core$List$filterMap,
				function (x) {
					return A3($tortus$elm_array_2d$Array2D$get, y, x, arr);
				},
				xs);
		},
		ys);
	...
	function (arr, _v0) {
		...
		return A2(
			...
			function (_v1) {
				var xx = _v1.a;
				var yy = _v1.b;
				return A3($tortus$elm_array_2d$Array2D$get, yy, xx, arr);
			},
			positions);
	});
...
var $author$project$Main$evolveAcre = F2(
	function (area, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var neighbours = A2(
			$author$project$Main$getNeighbours,
			area,
			_Utils_Tuple2(x, y));
		var _v1 = A2(
			$elm$core$Maybe$withDefault,
			'.',
			A3($tortus$elm_array_2d$Array2D$get, y, x, area));
		switch (_v1) {
			case '|':
				return (A2($author$project$Main$countAcre, neighbours, '#') >= 3) ? '#' : '|';
			case '#':
				return ((A2($author$project$Main$countAcre, neighbours, '#') > 0) && (A2($author$project$Main$countAcre, neighbours, '|') > 0)) ? '#' : '.';
			default:
				return (A2($author$project$Main$countAcre, neighbours, '|') >= 3) ? '|' : '.';
		}
	});
var $author$project$Main$getNestedPositions = function (arr) {
	var ys = A2(
		$elm$core$List$range,
		0,
		$tortus$elm_array_2d$Array2D$rows(arr) - 1);
...
var $author$project$Main$step = function (area) {
	var nestedPositions = $author$project$Main$getNestedPositions(area);
	var nextArea = $tortus$elm_array_2d$Array2D$fromList(
		A2(
			$elm$core$List$map,
			function (positions) {
				return A2(
					$elm$core$List$map,
					$author$project$Main$evolveAcre(area),
					positions);
			},
			nestedPositions));
	return nextArea;
...
var $author$project$Main$updateStep = function (model) {
	...
	var _v0 = function () {
		var _v1 = model.A;
		if (!_v1.$) {
			return _Utils_Tuple3(model.A, model.s, false);
		} else {
			var _v2 = A2($elm$core$Dict$get, key, model.s);
			if (_v2.$ === 1) {
				return _Utils_Tuple3(
					$elm$core$Maybe$Nothing,
					A3($elm$core$Dict$insert, key, steps, model.s),
					false);
			} else {
				var oldSteps = _v2.a;
				var loopSize = steps - oldSteps;
				var numberInLoop = A2($elm$core$Basics$modBy, loopSize, 1000000000 - oldSteps);
				var targetKey = A2(
					$elm$core$Maybe$withDefault,
					_List_Nil,
					$elm$core$List$head(
						A2(
							...
							function (_v3) {
								var k = _v3.a;
								var v = _v3.b;
								return _Utils_eq(v, oldSteps + numberInLoop) ? $elm$core$Maybe$Just(k) : $elm$core$Maybe$Nothing;
							},
							$elm$core$Dict$toList(model.s))));
				var targetArea = $author$project$Main$deserialize(targetKey);
				var resourceValue = $author$project$Main$getResourceValue(targetArea);
				return _Utils_Tuple3(
					$elm$core$Maybe$Just(resourceValue),
					model.s,
					true);
			}
		}
...
var $author$project$Main$getAcreSymbolAtPos = F2(
	function (area, _v0) {
		var x = _v0.a;
		var y = _v0.b;
...
var $author$project$Main$toCharElement = F2(
	function (area, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var symbol = $elm$core$String$fromChar(
			A2(
...
var $author$project$Main$view = function (model) {
	...
	var prognosisStr = function () {
		var _v0 = model.A;
		if (!_v0.$) {
			var prognosis = _v0.a;
			return $elm$core$String$fromInt(prognosis);
		} else {
			return '?';
		}
	}();
	...
	var elements = A3(
		...
		_List_Nil,
		nestedElements);
	var resourceValue = $author$project$Main$getResourceValue(area);
	return A2(
		$elm$html$Html$table,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Day 18: Settlers of The North Pole')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://adventofcode.com/2018/day/18')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('https://adventofcode.com/2018/day/18')
									]))
							]))
					])),
				A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										'Minutes: ' + $elm$core$String$fromInt(model.H))
									])),
								A2(
								$elm$html$Html$div,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text(
										'Value: ' + $elm$core$String$fromInt(resourceValue))
									])),
								A2(
								$elm$html$Html$div,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Prognosis: ' + prognosisStr)
									])),
								A2(
								$elm$html$Html$div,
								_List_Nil,
