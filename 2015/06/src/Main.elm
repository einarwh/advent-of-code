...
type Report = Unchecked String | Nice String | Naughty String
...
checkReport useNewRules report = 
  case report of 
    Unchecked str -> 
      if isNice useNewRules str then Nice str else Naughty str
    _ -> report 
...
countNice : List Report -> Int 
countNice reports = 
  reports |> List.map countAsNice |> List.sum 
...
toNaughtyHtmlElement : String -> List (Html Msg) 
toNaughtyHtmlElement str =
  let 
    textElement = Html.text str 
...
toNiceHtmlElement : String -> List (Html Msg)
toNiceHtmlElement str =
  let 
    textElement = Html.text str 
...
toReportHtmlElement report = 
  case report of 
    ...
    Naughty str -> toNaughtyHtmlElement str
    Nice str -> toNiceHtmlElement str
