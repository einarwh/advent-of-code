...
var $author$project$Main$hasIncreasingSequenceLoop = function (chars) {
	hasIncreasingSequenceLoop:
	while (true) {
		if ((chars.b && chars.b.b) && chars.b.b.b) {
			...
			var c = _v2.a;
			var rest = _v2.b;
			var cVal = $elm$core$Char$toCode(c);
			var bVal = $elm$core$Char$toCode(b);
			var aVal = $elm$core$Char$toCode(a);
			if (((bVal - aVal) === 1) && ((cVal - bVal) === 1)) {
				return true;
			} else {
				var $temp$chars = A2(
					$elm$core$List$cons,
				...
				chars = $temp$chars;
				continue hasIncreasingSequenceLoop;
			}
		} else {
			return false;
		}
...
var $author$project$Main$hasIncreasingSequence = function (s) {
	return $author$project$Main$hasIncreasingSequenceLoop(
		$elm$core$String$toList(s));
};
var $author$project$Main$hasOverlappingPairsLoop = F2(
	function (count, chars) {
		hasOverlappingPairsLoop:
		while (true) {
			if (chars.b && chars.b.b) {
				...
				if (_Utils_eq(a, b)) {
					if (count === 1) {
						...
						count = $temp$count;
						chars = $temp$chars;
						continue hasOverlappingPairsLoop;
					}
				} else {
					var $temp$count = count,
						$temp$chars = A2($elm$core$List$cons, b, rest);
					count = $temp$count;
					chars = $temp$chars;
					continue hasOverlappingPairsLoop;
				}
...
var $author$project$Main$hasOverlappingPairs = function (s) {
	return A2(
		$author$project$Main$hasOverlappingPairsLoop,
		0,
		$elm$core$String$toList(s));
};
var $author$project$Main$isCompliant = function (password) {
	return $author$project$Main$hasIncreasingSequence(password) && $author$project$Main$hasOverlappingPairs(password);
};
...
var $author$project$Main$nextChar = function (ch) {
	return (ch === 'z') ? 'a' : function (n) {
		return $elm$core$Char$fromCode(n + 1);
	}(
...
var $author$project$Main$nextIncLoop = F2(
	function (index, chars) {
		if (index < 0) {
			...
			var ch = A2(
				...
				'a',
				A2($elm$core$Array$get, index, chars));
			return (ch === 'z') ? A2(
				$author$project$Main$nextIncLoop,
				index - 1,
				A3($elm$core$Array$set, index, 'a', chars)) : A3(
				$elm$core$Array$set,
				index,
				$author$project$Main$nextChar(ch),
				chars);
		}
	});
var $author$project$Main$nextIncremental = function (password) {
	var len = $elm$core$String$length(password);
...
var $author$project$Main$indexOfLoop = F3(
	function (ix, element, list) {
		indexOfLoop:
		while (true) {
			if (!list.b) {
				return $elm$core$Maybe$Nothing;
...
var $author$project$Main$indexOf = F2(
	function (element, list) {
		return A3($author$project$Main$indexOfLoop, 0, element, list);
	});
...
var $author$project$Main$nextWithoutLetter = F2(
	function (c, s) {
		var chars = $elm$core$String$toList(s);
		var _v0 = A2($author$project$Main$indexOf, c, chars);
		if (!_v0.$) {
			var ix = _v0.a;
			var before = A2($elm$core$String$left, ix, s);
			var afterLen = $elm$core$String$length(s) - (ix + 1);
			var after = $elm$core$String$fromList(
				A2($elm$core$List$repeat, afterLen, 'a'));
			return _Utils_ap(
				before,
				_Utils_ap(
					$elm$core$String$fromChar(
						$author$project$Main$nextChar(c)),
					after));
		} else {
			return s;
		}
	});
var $author$project$Main$nextPassword = function (password) {
	return A2(
		$author$project$Main$nextWithoutLetter,
		'l',
		A2(
			$author$project$Main$nextWithoutLetter,
			'o',
...
var $author$project$Main$stepUntilValid = function (model) {
	...
	while (true) {
		...
		if ($author$project$Main$isCompliant(pwd)) {
			...
			var $temp$model = m;
			model = $temp$model;
			continue stepUntilValid;
		}
	}
};
var $author$project$Main$updateNextValid = function (model) {
	return $author$project$Main$stepUntilValid(
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg) {
			...
			default:
				return _Utils_Tuple2(
					$author$project$Main$updateNextValid(model),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$Faster = 4;
var $author$project$Main$NextValid = 2;
...
var $author$project$Main$getPwdStyle = function (compliant) {
	return compliant ? _List_fromArray(
		[
...
var $author$project$Main$view = function (model) {
	...
	var pwdElement = A2(
		...
		$author$project$Main$getPwdStyle(
			$author$project$Main$isCompliant(pwd)),
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Day 11: Corporate Policy')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://adventofcode.com/2015/day/11')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('https://adventofcode.com/2015/day/11')
									]))
							]))
					])),
				A2(
