...
toSouthEastPipe yPos xPos = 
  let 
    ...
    ySouthish = yPos * unitSize + 3 * unitSize // 4
    xEast = (xPos + 1) * unitSize 
    xEastish = xPos * unitSize + 3 * unitSize // 4
    southPt = (String.fromInt xCenter) ++ "," ++ (String.fromInt ySouth) 
    southishPt = (String.fromInt xCenter) ++ "," ++ (String.fromInt ySouthish) 
    centerPt = (String.fromInt xCenter) ++ "," ++ (String.fromInt yCenter)
    eastPt = (String.fromInt xEast) ++ "," ++ (String.fromInt yCenter)
    eastishPt = (String.fromInt xEastish) ++ "," ++ (String.fromInt yCenter)
    str = "M " ++ southPt ++ " L " ++ southishPt ++ " Q " ++ centerPt ++ ", " ++ eastishPt ++ " L " ++ eastPt 
  in
    Svg.path
      [ d str 
      , fill "none"
...
toSouthWestPipe yPos xPos = 
  let 
    ...
    ySouthish = yPos * unitSize + 3 * unitSize // 4
    xWest = xPos * unitSize 
    xWestish = xPos * unitSize + unitSize // 4
    southPt = (String.fromInt xCenter) ++ "," ++ (String.fromInt ySouth) 
    southishPt = (String.fromInt xCenter) ++ "," ++ (String.fromInt ySouthish) 
    centerPt = (String.fromInt xCenter) ++ "," ++ (String.fromInt yCenter)
    westPt = (String.fromInt xWest) ++ "," ++ (String.fromInt yCenter)
    westishPt = (String.fromInt xWestish) ++ "," ++ (String.fromInt yCenter)
    str = "M " ++ southPt ++ " L " ++ southishPt ++ " Q " ++ centerPt ++ ", " ++ westishPt ++ " L " ++ westPt 
  in
    Svg.path
      [ d str 
      , fill "none"
...
toNorthEastPipe yPos xPos = 
  let 
    ...
    yNorthish = yPos * unitSize + unitSize // 4
    xEast = (xPos + 1) * unitSize 
    xEastish = xPos * unitSize + 3 * unitSize // 4
    northPt = (String.fromInt xCenter) ++ "," ++ (String.fromInt yNorth) 
    northishPt = (String.fromInt xCenter) ++ "," ++ (String.fromInt yNorthish) 
    centerPt = (String.fromInt xCenter) ++ "," ++ (String.fromInt yCenter)
    eastPt = (String.fromInt xEast) ++ "," ++ (String.fromInt yCenter)
    eastishPt = (String.fromInt xEastish) ++ "," ++ (String.fromInt yCenter)
    str = "M " ++ northPt ++ " L " ++ northishPt ++ " Q " ++ centerPt ++ ", " ++ eastishPt ++ " L " ++ eastPt 
  in
    Svg.path
      [ d str 
      , fill "none"
...
toNorthWestPipe yPos xPos = 
  let 
    ...
    westPt = (String.fromInt xWest) ++ "," ++ (String.fromInt yCenter)
    westishPt = (String.fromInt xWestish) ++ "," ++ (String.fromInt yCenter)
    str = "M " ++ northPt ++ " L " ++ northishPt ++ " Q " ++ centerPt ++ ", " ++ westishPt ++ " L " ++ westPt 
  in
    Svg.path
      [ d str 
      , fill "none"
