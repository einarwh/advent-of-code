...
var $author$project$Main$overlapping = F2(
	function (box1, box2) {
		return (_Utils_cmp(box1.C, box2.x) > -1) && ((_Utils_cmp(box2.C, box1.x) > -1) && ((_Utils_cmp(box1.D, box2.y) > -1) && (_Utils_cmp(box2.D, box1.y) > -1)));
	});
...
var $author$project$Main$calculateGearRatio = F2(
	function (boxedParts, boxedSymbol) {
		var boxedSymbolParts = A2(
			$elm$core$List$filter,
			function (bn) {
				return A2($author$project$Main$overlapping, bn.f, boxedSymbol.f);
			},
			boxedParts);
		if ((boxedSymbolParts.b && boxedSymbolParts.b.b) && (!boxedSymbolParts.b.b.b)) {
			var bp1 = boxedSymbolParts.a;
			var _v1 = boxedSymbolParts.b;
			var bp2 = _v1.a;
			var v2 = A2(
				$elm$core$Maybe$withDefault,
				0,
				$elm$core$String$toInt(bp2.s));
			var v1 = A2(
				$elm$core$Maybe$withDefault,
				0,
				$elm$core$String$toInt(bp1.s));
			return v1 * v2;
		} else {
			return 0;
		}
...
var $author$project$Main$isGearPart = F2(
	function (boxedParts, boxedSymbol) {
		var boxedSymbolParts = A2(
			$elm$core$List$filter,
			function (bn) {
...
var $author$project$Main$isPartNumber = F2(
	function (symbolBoxes, _v0) {
		var box = _v0.f;
		var val = _v0.s;
		return A2(
			$elm$core$List$any,
			$author$project$Main$overlapping(box),
			symbolBoxes);
	});
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {ai: index, ak: match, aO: number, aU: submatches};
	});
...
var $author$project$Main$parseNumbers = function (line) {
	...
	var matches = A2($elm$regex$Regex$find, numberRegex, line);
	return A2(
		$elm$core$List$map,
		function (m) {
			return _Utils_Tuple2(m.ai, m.ak);
		},
		matches);
};
var $author$project$Main$toNumberBox = F2(
	function (_v0, s) {
		var x = _v0.K;
		var y = _v0.L;
		return {
			C: (x + $elm$core$String$length(s)) - 1,
			x: x,
			D: y,
			y: y
		};
	});
var $author$project$Main$parseNumbersWithBox = F2(
	function (y, line) {
		return A2(
			$elm$core$List$map,
			function (_v0) {
				...
				return {
					f: A2(
						$author$project$Main$toNumberBox,
						{K: x, L: y},
						s),
					s: s
				};
			},
			$author$project$Main$parseNumbers(line));
	});
var $author$project$Main$parseSymbols = function (line) {
	var symbolRegex = A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
		$elm$regex$Regex$fromString('[^\\d\\.]'));
	var matches = A2($elm$regex$Regex$find, symbolRegex, line);
	return A2(
		$elm$core$List$map,
		function (m) {
			return _Utils_Tuple2(m.ai, m.ak);
...
var $author$project$Main$toSymbolBox = function (_v0) {
	var x = _v0.K;
	var y = _v0.L;
	return {C: x + 1, x: x - 1, D: y + 1, y: y - 1};
};
var $author$project$Main$parseSymbolsWithBox = F2(
	function (y, line) {
		return A2(
			$elm$core$List$map,
			function (_v0) {
				...
				var s = _v0.b;
				return {
					f: $author$project$Main$toSymbolBox(
						{K: x, L: y}),
					s: s
				};
			},
			$author$project$Main$parseSymbols(line));
	});
...
var $author$project$Main$init = function (_v0) {
	...
	var boxedSymbols = $elm$core$List$concat(
		A2($elm$core$List$indexedMap, $author$project$Main$parseSymbolsWithBox, lines));
	var symbolBoxes = A2(
		$elm$core$List$map,
		function (bt) {
			return bt.f;
		...
		boxedSymbols);
	var boxedNumbers = $elm$core$List$concat(
		A2($elm$core$List$indexedMap, $author$project$Main$parseNumbersWithBox, lines));
	var boxedParts = A2(
		$elm$core$List$filter,
		$author$project$Main$isPartNumber(symbolBoxes),
		boxedNumbers);
	var gearBoxes = A2(
		$elm$core$List$map,
		function (bt) {
		...
		A2(
			$elm$core$List$filter,
			$author$project$Main$isGearPart(boxedParts),
			boxedSymbols));
	var gearRatio = $elm$core$List$sum(
		A2(
			$elm$core$List$map,
			$author$project$Main$calculateGearRatio(boxedParts),
			boxedSymbols));
	var nonGearBoxes = A2(
		$elm$core$List$map,
		function (bt) {
		...
		A2(
			$elm$core$List$filter,
			function (bs) {
				return !A2($author$project$Main$isGearPart, boxedParts, bs);
			},
			boxedSymbols));
	var partBoxes = A2(
		$elm$core$List$map,
	...
	var numberBoxes = A2(
		...
		boxedNumbers);
	var boxedNonParts = A2(
		$elm$core$List$filter,
		function (bn) {
			return !A2($author$project$Main$isPartNumber, symbolBoxes, bn);
		},
		boxedNumbers);
	var nonPartBoxes = A2(
		$elm$core$List$map,
		...
		boxedNonParts);
	var model = {aa: 0, ac: '...', M: gearBoxes, N: gearRatio, O: lines, Q: nonGearBoxes, R: nonPartBoxes, T: partBoxes, U: partSum};
...
var $author$project$Main$unitSize = 6;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$fontSize('6px'),
...
var $author$project$Main$lineToCharBox = F2(
	function (y, line) {
		return A2(
...
var $author$project$Main$toColoredBox = F2(
	function (fillColor, box) {
		var yVal = $author$project$Main$unitSize * box.y;
		var yDiff = (box.D - box.y) + 1;
		var xVal = $author$project$Main$unitSize * box.x;
		var xDiff = (box.C - box.x) + 1;
		var w = $author$project$Main$unitSize * xDiff;
		var h = $author$project$Main$unitSize * yDiff;
		return A2(
			$elm$svg$Svg$rect,
			_List_fromArray(
				[
...
var $author$project$Main$toSvg = function (model) {
	var svgWidth = $elm$core$String$fromInt($author$project$Main$unitSize * 140);
	var svgHeight = $elm$core$String$fromInt($author$project$Main$unitSize * 140);
	var partBoxes = model.T;
	var partRects = A2(
		$elm$core$List$map,
		$author$project$Main$toColoredBox('lightgreen'),
		partBoxes);
	var nonPartBoxes = model.R;
	var nonPartRects = A2(
		$elm$core$List$map,
		$author$project$Main$toColoredBox('pink'),
		nonPartBoxes);
	var nonGearBoxes = model.Q;
	var nonGearRects = A2(
		$elm$core$List$map,
		$author$project$Main$toColoredBox('lightblue'),
		nonGearBoxes);
	var lines = model.O;
	var gearBoxes = model.M;
	var gearRects = A2(
		$elm$core$List$map,
		$author$project$Main$toColoredBox('plum'),
		gearBoxes);
	var charTexts = $elm$core$List$concat(
		A2($elm$core$List$indexedMap, $author$project$Main$lineToCharBox, lines));
	var lst = _Utils_ap(
		partRects,
		_Utils_ap(
			nonPartRects,
			_Utils_ap(
				gearRects,
				_Utils_ap(nonGearRects, charTexts))));
	return A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Day 3: Gear Ratios')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://adventofcode.com/2023/day/3')
									]),
								_List_fromArray(
									[
										$elm$svg$Svg$text('https://adventofcode.com/2023/day/3')
									]))
							]))
					])),
				A2(
