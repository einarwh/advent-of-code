...
toBoxElement factor (pos1, pos2) = 
  ...
  in 
    Svg.polygon [ Svg.Attributes.points pts, Svg.Attributes.fill "none", Svg.Attributes.stroke "currentcolor" ] []
...
toPolygon model = 
  ...
  in 
    Svg.polygon [ Svg.Attributes.points pts, Svg.Attributes.fill "#32CD32", Svg.Attributes.stroke "#32CD32" ] []
