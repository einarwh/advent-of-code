...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aa: fragment, ac: host, ag: path, ai: port_, am: protocol, an: query};
	});
...
var $author$project$Main$findMaxJoltage = F3(
	function (_v0, batteryCount, bank) {
		findMaxJoltage:
		while (true) {
			var joltage = _v0.a;
			var offset = _v0.b;
			var indexes = _v0.c;
			if (!batteryCount) {
				return _Utils_Tuple2(joltage, indexes);
			} else {
				var _v1 = A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$take,
								($elm$core$List$length(bank) - batteryCount) + 1,
								bank))));
				var ix = _v1.a;
				var battery = _v1.b;
				var $temp$_v0 = _Utils_Tuple3(
					(joltage * 10) + battery,
					(offset + ix) + 1,
					A2($elm$core$List$cons, offset + ix, indexes)),
					$temp$batteryCount = batteryCount - 1,
					$temp$bank = A2($elm$core$List$drop, ix + 1, bank);
				_v0 = $temp$_v0;
				batteryCount = $temp$batteryCount;
				bank = $temp$bank;
				continue findMaxJoltage;
			}
		}
	});
		...
		var highlighted = A2(
			...
			function (i) {
				return function (ch) {
					return _Utils_Tuple2(
						ch,
						A2($elm$core$List$member, i, indexes));
				};
			},
			bank);
		return _Utils_update(
...
var $author$project$Main$view = function (model) {
	...
	var nestedUnprocessedElements = A2(
		$elm$core$List$map,
		function (bank) {
			return A2(
				$elm$core$List$map,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Day 3: Lobby')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://adventofcode.com/2025/day/3')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('https://adventofcode.com/2025/day/3')
									]))
							]))
					])),
				A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$elm$core$String$fromInt(totalJoltage))
									])),
								A2(
								$elm$html$Html$div,
								_List_Nil,
