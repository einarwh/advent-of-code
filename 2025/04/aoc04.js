...
var $author$project$Main$initModel = function (dataSource) {
	...
	var symbolLists = A2(
		...
		A2($elm$core$String$split, '\n', data));
	var height = $elm$core$List$length(symbolLists);
	var rolls = $elm$core$Set$fromList(
		A2(
			$elm$core$List$map,
...
var $author$project$Main$inaccessible = F2(
	function (rolls, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var neighbours = _List_fromArray(
			[
...
var $author$project$Main$remove = function (rolls) {
	return A2(
		$elm$core$Set$filter,
		$author$project$Main$inaccessible(rolls),
		rolls);
};
...
var $author$project$Main$updateStep = function (model) {
	var updatedRolls = $author$project$Main$remove(model.y);
	var removed = $elm$core$Set$size(model.y) - $elm$core$Set$size(updatedRolls);
	return (removed > 0) ? _Utils_update(
		model,
...
var $author$project$Main$getNestedPositions = F2(
	function (rows, columns) {
		...
		var xs = A2($elm$core$List$range, 0, columns - 1);
		return A2(
			$elm$core$List$map,
			function (y) {
				return A2(
...
var $author$project$Main$view = function (model) {
	...
	var nestedPositions = A2($author$project$Main$getNestedPositions, model.J, model.Q);
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Day 4: Printing Department')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://adventofcode.com/2025/day/4')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('https://adventofcode.com/2025/day/4')
									]))
							]))
					])),
				A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										'Removed: ' + $elm$core$String$fromInt(model.D))
									]))
							]))
					])),
				A2(
