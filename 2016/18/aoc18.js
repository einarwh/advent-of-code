...
var $author$project$Main$countSafe = function (s) {
...
var $author$project$Main$initRowText = function (dataSource) {
	if (dataSource === 1) {
...
var $author$project$Main$ruleList = _List_fromArray(
	[
		_Utils_Tuple2(
		_List_fromArray(
			['.', '.', '.']),
...
var $author$project$Main$rules = $elm$core$Dict$fromList($author$project$Main$ruleList);
var $elm$core$String$foldr = _String_foldr;
var $elm$core$String$toList = function (string) {
	return A3($elm$core$String$foldr, $elm$core$List$cons, _List_Nil, string);
};
var $author$project$Main$windowed = function (lst) {
...
var $author$project$Main$getNextRow = function (row) {
	var exp = '.' + (row + '.');
		...
		A2(
			...
			function (cs) {
				return A2(
					...
					'X',
					A2($elm$core$Dict$get, cs, $author$project$Main$rules));
			},
			$author$project$Main$windowed(
				$elm$core$String$toList(exp))));
};
...
var $author$project$Main$toStyledCharElement = function (symbol) {
	switch (symbol) {
		case '^':
			return A2(
				$elm$html$Html$span,
		...
		case '.':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('ok adaptive')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('.')
...
var $author$project$Main$view = function (model) {
	...
	var nestedElements = A2(
		...
		function (r) {
			return A2(
				$elm$core$List$map,
				$author$project$Main$toStyledCharElement,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Day 18: Like a Rogue')
									]))
							]))
					])),
				A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										'Rows: ' + $elm$core$String$fromInt(model.E))
									])),
								A2(
								$elm$html$Html$div,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text(
										'Safe: ' + $elm$core$String$fromInt(model.F))
									]))
							]))
					])),
				A2(
