...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A2($author$project$Main$initModel, 1, false),
...
var $author$project$Main$movePosition = F3(
	function (pos1, pos2, pwd) {
		var ch = A3($elm$core$String$slice, pos1, pos1 + 1, pwd);
		var before1 = A2($elm$core$String$left, pos1, pwd);
		var after1 = A2($elm$core$String$dropLeft, pos1 + 1, pwd);
		var removed = _Utils_ap(before1, after1);
		var after2 = A2($elm$core$String$dropLeft, pos2, removed);
		var before2 = A2($elm$core$String$left, pos2, removed);
		return _Utils_ap(
			before2,
			_Utils_ap(ch, after2));
	});
var $author$project$Main$tryMovePositionInverse = F2(
	function (op, pwd) {
		var _v0 = A2($elm$core$String$split, ' ', op);
		if ((((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) && _v0.b.b.b.b.b.b) && (!_v0.b.b.b.b.b.b.b)) {
			...
			var _v6 = _Utils_Tuple2(
				$elm$core$String$toInt(str1),
				$elm$core$String$toInt(str2));
			if ((!_v6.a.$) && (!_v6.b.$)) {
				var pos1 = _v6.a.a;
				var pos2 = _v6.b.a;
				return A3($author$project$Main$movePosition, pos2, pos1, pwd);
			} else {
				return pwd;
			}
		} else {
...
var $author$project$Main$tryReversePositions = F2(
	function (op, pwd) {
		var _v0 = A2($elm$core$String$split, ' ', op);
		if (((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) && (!_v0.b.b.b.b.b.b)) {
			...
			if ((!_v5.a.$) && (!_v5.b.$)) {
				...
				var section = A2(
					...
					pos1,
					A2($elm$core$String$left, pos2 + 1, pwd));
				var reversed = $elm$core$String$fromList(
					$elm$core$List$reverse(
						$elm$core$String$toList(section)));
				var before = A2($elm$core$String$left, pos1, pwd);
				var after = A2($elm$core$String$dropLeft, pos2 + 1, pwd);
				return _Utils_ap(
					before,
					_Utils_ap(reversed, after));
			} else {
				return pwd;
			}
		} else {
...
var $author$project$Main$tryReversePositionsInverse = $author$project$Main$tryReversePositions;
...
var $author$project$Main$rotateRight = F2(
	function (steps, pwd) {
		var right = A2($elm$core$String$right, steps, pwd);
		var left = A2($elm$core$String$dropRight, steps, pwd);
		return _Utils_ap(right, left);
	});
var $author$project$Main$tryRotateRight = F2(
	function (op, pwd) {
		var _v0 = A2($elm$core$String$split, ' ', op);
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && (!_v0.b.b.b.b.b)) {
			...
			if (!_v4.$) {
				var steps = _v4.a;
				return A2($author$project$Main$rotateRight, steps, pwd);
			} else {
				return pwd;
			}
		} else {
...
var $author$project$Main$tryRotateLeftInverse = $author$project$Main$tryRotateRight;
...
var $author$project$Main$rotateLeft = F2(
	function (steps, pwd) {
		var right = A2($elm$core$String$dropLeft, steps, pwd);
		var left = A2($elm$core$String$left, steps, pwd);
		return _Utils_ap(right, left);
	});
var $author$project$Main$tryRotatePositionInverse = F2(
	function (op, pwd) {
		var _v0 = $elm$core$List$head(
			$elm$core$List$reverse(
				A2($elm$core$String$split, ' ', op)));
		if (!_v0.$) {
			var letter = _v0.a;
			var _v1 = $elm$core$List$head(
				A2($elm$core$String$indexes, letter, pwd));
			if (!_v1.$) {
				var ix = _v1.a;
				var reversedIx = (!ix) ? ((((2 * $elm$core$String$length(pwd)) - 2) / 2) | 0) : ((!A2($elm$core$Basics$modBy, 2, ix)) ? ((((ix + $elm$core$String$length(pwd)) - 2) / 2) | 0) : (((ix - 1) / 2) | 0));
				var steps = (reversedIx >= 4) ? (reversedIx + 2) : (reversedIx + 1);
				return A2($author$project$Main$rotateLeft, steps, pwd);
			} else {
				return pwd;
			}
		} else {
...
var $author$project$Main$tryRotateLeft = F2(
	function (op, pwd) {
		var _v0 = A2($elm$core$String$split, ' ', op);
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && (!_v0.b.b.b.b.b)) {
			var _v1 = _v0.b;
...
var $author$project$Main$tryRotateRightInverse = $author$project$Main$tryRotateLeft;
...
var $author$project$Main$swapLetters = F3(
	function (letter1, letter2, password) {
		return A3(
			...
			A3(
				...
				letter2,
				letter1,
				A3($elm$core$String$replace, letter1, '_', password)));
	});
var $author$project$Main$trySwapLetters = F2(
	function (op, pwd) {
		var _v0 = A2($elm$core$String$split, ' ', op);
		if ((((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) && _v0.b.b.b.b.b.b) && (!_v0.b.b.b.b.b.b.b)) {
			var _v1 = _v0.b;
			...
			var _v5 = _v4.b;
			var letter2 = _v5.a;
			return A3($author$project$Main$swapLetters, letter1, letter2, pwd);
		} else {
			return pwd;
		}
	});
var $author$project$Main$trySwapLettersInverse = $author$project$Main$trySwapLetters;
var $author$project$Main$trySwapPositions = F2(
	function (op, pwd) {
		var _v0 = A2($elm$core$String$split, ' ', op);
		if ((((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) && _v0.b.b.b.b.b.b) && (!_v0.b.b.b.b.b.b.b)) {
			var _v1 = _v0.b;
			...
			if ((!_v6.a.$) && (!_v6.b.$)) {
				var pos1 = _v6.a.a;
				var pos2 = _v6.b.a;
				var letter2 = A3($elm$core$String$slice, pos2, pos2 + 1, pwd);
				var letter1 = A3($elm$core$String$slice, pos1, pos1 + 1, pwd);
				return A3($author$project$Main$swapLetters, letter1, letter2, pwd);
			} else {
				return pwd;
			}
...
var $author$project$Main$trySwapPositionsInverse = $author$project$Main$trySwapPositions;
var $author$project$Main$descramblePassword = F2(
	function (op, pwd) {
		return A2($elm$core$String$startsWith, 'swap letter', op) ? A2($author$project$Main$trySwapLettersInverse, op, pwd) : (A2($elm$core$String$startsWith, 'swap position', op) ? A2($author$project$Main$trySwapPositionsInverse, op, pwd) : (A2($elm$core$String$startsWith, 'rotate left', op) ? A2($author$project$Main$tryRotateLeftInverse, op, pwd) : (A2($elm$core$String$startsWith, 'rotate right', op) ? A2($author$project$Main$tryRotateRightInverse, op, pwd) : (A2($elm$core$String$startsWith, 'rotate based', op) ? A2($author$project$Main$tryRotatePositionInverse, op, pwd) : (A2($elm$core$String$startsWith, 'reverse positions', op) ? A2($author$project$Main$tryReversePositionsInverse, op, pwd) : (A2($elm$core$String$startsWith, 'move position', op) ? A2($author$project$Main$tryMovePositionInverse, op, pwd) : pwd))))));
	});
var $author$project$Main$tryMovePosition = F2(
	function (op, pwd) {
		var _v0 = A2($elm$core$String$split, ' ', op);
		if ((((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) && _v0.b.b.b.b.b.b) && (!_v0.b.b.b.b.b.b.b)) {
			var _v1 = _v0.b;
			...
			if ((!_v6.a.$) && (!_v6.b.$)) {
				var pos1 = _v6.a.a;
				var pos2 = _v6.b.a;
				return A3($author$project$Main$movePosition, pos1, pos2, pwd);
			} else {
				return pwd;
			}
		} else {
...
var $author$project$Main$tryRotatePosition = F2(
	function (op, pwd) {
		var _v0 = $elm$core$List$head(
			$elm$core$List$reverse(
				A2($elm$core$String$split, ' ', op)));
...
var $author$project$Main$scramblePassword = F2(
	function (op, pwd) {
		return A2($elm$core$String$startsWith, 'swap letter', op) ? A2($author$project$Main$trySwapLetters, op, pwd) : (A2($elm$core$String$startsWith, 'swap position', op) ? A2($author$project$Main$trySwapPositions, op, pwd) : (A2($elm$core$String$startsWith, 'rotate left', op) ? A2($author$project$Main$tryRotateLeft, op, pwd) : (A2($elm$core$String$startsWith, 'rotate right', op) ? A2($author$project$Main$tryRotateRight, op, pwd) : (A2($elm$core$String$startsWith, 'rotate based', op) ? A2($author$project$Main$tryRotatePosition, op, pwd) : (A2($elm$core$String$startsWith, 'reverse positions', op) ? A2($author$project$Main$tryReversePositions, op, pwd) : (A2($elm$core$String$startsWith, 'move position', op) ? A2($author$project$Main$tryMovePosition, op, pwd) : pwd))))));
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg) {
			...
			case 5:
				return _Utils_Tuple2(
					$author$project$Main$updateToggleDescramble(model),
					$elm$core$Platform$Cmd$none);
			case 6:
				return _Utils_Tuple2(
					A2($author$project$Main$initModel, 1, false),
			...
			default:
				return _Utils_Tuple2(
					A2($author$project$Main$initModel, 0, true),
					$elm$core$Platform$Cmd$none);
		}
	});
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Day 21: Scrambled Letters and Hash')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://adventofcode.com/2016/day/21')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('https://adventofcode.com/2016/day/21')
									]))
							]))
					])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										model.p ? $elm$html$Html$text(playButtonText) : $elm$html$Html$text('Pause')
									])),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
