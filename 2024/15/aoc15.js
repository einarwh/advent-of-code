...
var $author$project$Aoc15Element$SampleLarger = 2;
var $author$project$Aoc15Element$Input = 0;
var $author$project$Aoc15Element$defaultTickInterval = 10;
...
var $author$project$Aoc15Element$findRobotLoop = F2(
...
var $author$project$Aoc15Element$getAllPositions = function (board) {
	var ys = A2(
		$elm$core$List$range,
		0,
...
var $author$project$Aoc15Element$findRobot = function (warehouse) {
	return A2(
		$author$project$Aoc15Element$findRobotLoop,
		warehouse,
		$author$project$Aoc15Element$getAllPositions(warehouse));
};
...
var $author$project$Aoc15Element$widen = function (text) {
	return A3(
...
var $author$project$Aoc15Element$initModel = F2(
	function (wide, dataSource) {
		var data = $author$project$Aoc15Element$read(dataSource);
		var _v0 = function () {
		...
		var basicRows = _v0.a;
		var moves = _v0.b;
		var rows = wide ? A2($elm$core$List$map, $author$project$Aoc15Element$widen, basicRows) : basicRows;
		...
		var robot = $author$project$Aoc15Element$findRobot(warehouse);
		return {r: dataSource, Z: false, N: !dataSource, M: '?', H: moves, B: true, C: robot, x: $author$project$Aoc15Element$defaultTickInterval, z: warehouse, l: wide};
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Aoc15Element$init = function (_v0) {
	return _Utils_Tuple2(
		A2($author$project$Aoc15Element$initModel, false, 2),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Aoc15Element$KeyDown = function (a) {
	return {$: 11, a: a};
};
var $author$project$Aoc15Element$Tick = {$: 0};
...
var $author$project$Aoc15Element$subscriptions = function (model) {
	var tickSub = model.B ? $elm$core$Platform$Sub$none : A2(
		$elm$time$Time$every,
		model.x,
		function (_v0) {
			return $author$project$Aoc15Element$Tick;
		});
	var keySub = $ohanhi$keyboard$Keyboard$downs($author$project$Aoc15Element$KeyDown);
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[tickSub, keySub]));
};
var $author$project$Aoc15Element$SampleSituation = 3;
var $author$project$Aoc15Element$SampleSmaller = 1;
...
var $author$project$Aoc15Element$updateClear = function (model) {
	return A2($author$project$Aoc15Element$initModel, model.l, model.r);
};
var $author$project$Aoc15Element$moveToOffset = function (move) {
	switch (move) {
		case '^':
...
var $author$project$Aoc15Element$moveStep = F2(
	function (move, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		var _v1 = $author$project$Aoc15Element$moveToOffset(move);
		var dx = _v1.a;
		var dy = _v1.b;
...
var $author$project$Aoc15Element$moveStuff = F2(
...
var $author$project$Aoc15Element$zip = F2(
	function (lst1, lst2) {
		...
		if (_v0.a.b && _v0.b.b) {
			...
			return A2(
				$elm$core$List$cons,
				_Utils_Tuple2(h1, h2),
				A2($author$project$Aoc15Element$zip, r1, r2));
		} else {
			return _List_Nil;
		}
	});
var $author$project$Aoc15Element$tryFindSpaceDoubleLoop = F4(
	function (warehouse, move, positionsToMove, swaps) {
		tryFindSpaceDoubleLoop:
		while (true) {
			var nextPositions = A2(
				$elm$core$List$map,
				$author$project$Aoc15Element$moveStep(move),
				positionsToMove);
			var proposedSwaps = A2($author$project$Aoc15Element$zip, positionsToMove, nextPositions);
...
var $author$project$Aoc15Element$tryFindSpaceDouble = F3(
	function (warehouse, robot, move) {
		return A4(
			$author$project$Aoc15Element$tryFindSpaceDoubleLoop,
			warehouse,
			move,
			_List_fromArray(
				[robot]),
...
var $author$project$Aoc15Element$tryFindSpaceSimpleLoop = F4(
	function (warehouse, move, pos, swaps) {
		tryFindSpaceSimpleLoop:
		while (true) {
			var _v0 = A2($author$project$Aoc15Element$moveStep, move, pos);
			var x = _v0.a;
			var y = _v0.b;
			var nextSwaps = A2(
				$elm$core$List$cons,
...
var $author$project$Aoc15Element$tryFindSpaceSimple = F3(
	function (warehouse, robot, move) {
		return A4($author$project$Aoc15Element$tryFindSpaceSimpleLoop, warehouse, move, robot, _List_Nil);
	});
var $author$project$Aoc15Element$tryFindSpace = F4(
	function (wide, warehouse, robot, move) {
		if (wide) {
			switch (move) {
				case '^':
					return A3($author$project$Aoc15Element$tryFindSpaceDouble, warehouse, robot, move);
				case 'v':
					return A3($author$project$Aoc15Element$tryFindSpaceDouble, warehouse, robot, move);
				case '<':
					return A3($author$project$Aoc15Element$tryFindSpaceSimple, warehouse, robot, move);
				case '>':
					return A3($author$project$Aoc15Element$tryFindSpaceSimple, warehouse, robot, move);
				default:
					return A3($author$project$Aoc15Element$tryFindSpaceSimple, warehouse, robot, move);
...
var $author$project$Aoc15Element$tryMoveRobot = F4(
	function (wide, warehouse, robot, move) {
		var swaps = A4($author$project$Aoc15Element$tryFindSpace, wide, warehouse, robot, move);
		if (!$elm$core$List$length(swaps)) {
			return _Utils_Tuple2(warehouse, robot);
		} else {
			var wh = A2($author$project$Aoc15Element$moveStuff, warehouse, swaps);
			var rb = A2($author$project$Aoc15Element$moveStep, move, robot);
			return _Utils_Tuple2(wh, rb);
		}
	});
var $author$project$Aoc15Element$updateKey = F2(
	function (move, model) {
		var wide = model.l;
		var warehouse = model.z;
		var robot = model.C;
		var _v0 = A4($author$project$Aoc15Element$tryMoveRobot, wide, warehouse, robot, move);
		var wh = _v0.a;
		var rb = _v0.b;
		var _v1 = rb;
		var rx = _v1.a;
...
var $author$project$Aoc15Element$updateStep = function (model) {
	var wide = model.l;
	var warehouse = model.z;
	var robot = model.C;
	var _v0 = model.H;
	if (!_v0.b) {
		...
		var move = _v0.a;
		var movesLeft = _v0.b;
		var _v1 = A4($author$project$Aoc15Element$tryMoveRobot, wide, warehouse, robot, move);
		var wh = _v1.a;
		var rb = _v1.b;
		var _v2 = rb;
		var rx = _v2.a;
...
var $author$project$Aoc15Element$updateTogglePlay = function (model) {
	return _Utils_update(
		model,
		{B: !model.B});
};
var $author$project$Aoc15Element$updateToggleWide = function (model) {
	return A2($author$project$Aoc15Element$initModel, !model.l, model.r);
};
var $author$project$Aoc15Element$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 6:
				return _Utils_Tuple2(
					$author$project$Aoc15Element$updateClear(model),
					$elm$core$Platform$Cmd$none);
			case 0:
				return _Utils_Tuple2(
					$author$project$Aoc15Element$updateStep(model),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					$author$project$Aoc15Element$updateStep(model),
			...
			case 2:
				return _Utils_Tuple2(
					$author$project$Aoc15Element$updateTogglePlay(model),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					$author$project$Aoc15Element$updateToggleWide(model),
					$elm$core$Platform$Cmd$none);
			case 7:
				return _Utils_Tuple2(
					A2($author$project$Aoc15Element$initModel, model.l, 0),
					$elm$core$Platform$Cmd$none);
			case 8:
				return _Utils_Tuple2(
					A2($author$project$Aoc15Element$initModel, model.l, 1),
					$elm$core$Platform$Cmd$none);
			case 9:
				return _Utils_Tuple2(
					A2($author$project$Aoc15Element$initModel, model.l, 2),
					$elm$core$Platform$Cmd$none);
			case 10:
				return _Utils_Tuple2(
					A2($author$project$Aoc15Element$initModel, model.l, 3),
					$elm$core$Platform$Cmd$none);
			default:
				var rawKey = msg.a;
					...
					if (!_v1.$) {
						switch (_v1.a.$) {
							case 21:
								var _v2 = _v1.a;
								return _Utils_Tuple2(
									A2($author$project$Aoc15Element$updateKey, '^', model),
									$elm$core$Platform$Cmd$none);
							case 19:
								var _v3 = _v1.a;
								return _Utils_Tuple2(
							...
							case 18:
								var _v4 = _v1.a;
								return _Utils_Tuple2(
									A2($author$project$Aoc15Element$updateKey, 'v', model),
									$elm$core$Platform$Cmd$none);
							case 20:
								var _v5 = _v1.a;
								return _Utils_Tuple2(
...
var $author$project$Aoc15Element$Clear = {$: 6};
var $author$project$Aoc15Element$Faster = {$: 4};
var $author$project$Aoc15Element$Slower = {$: 5};
var $author$project$Aoc15Element$Step = {$: 1};
var $author$project$Aoc15Element$TogglePlay = {$: 2};
var $author$project$Aoc15Element$ToggleWide = {$: 3};
var $author$project$Aoc15Element$UseInput = {$: 7};
var $author$project$Aoc15Element$UseLarger = {$: 9};
var $author$project$Aoc15Element$UseSituation = {$: 10};
var $author$project$Aoc15Element$UseSmaller = {$: 8};
...
var $author$project$Aoc15Element$gpsCoordinate = function (_v0) {
	var x = _v0.a;
	var y = _v0.b;
	return (y * 100) + x;
};
...
var $author$project$Aoc15Element$isBox = F2(
	function (wh, _v0) {
		var x = _v0.a;
		var y = _v0.b;
		return (_Utils_eq(
...
var $author$project$Aoc15Element$toRowElements = function (rowText) {
	return _List_fromArray(
		[
...
var $author$project$Aoc15Element$toWarehouseRows = function (warehouse) {
	var ys = A2(
		$elm$core$List$range,
		0,
...
var $author$project$Aoc15Element$view = function (model) {
	var warehouse = model.z;
	var textFontSize = model.N ? '12px' : '28px';
	var rows = $author$project$Aoc15Element$toWarehouseRows(warehouse);
	var gpsSum = function () {
		if ($elm$core$List$isEmpty(model.H)) {
			var positions = $author$project$Aoc15Element$getAllPositions(warehouse);
			var boxPositions = A2(
				$elm$core$List$filterMap,
				$author$project$Aoc15Element$isBox(warehouse),
				positions);
			return $elm$core$String$fromInt(
				$elm$core$List$sum(
					A2($elm$core$List$map, $author$project$Aoc15Element$gpsCoordinate, boxPositions)));
		} else {
			return '?';
		}
	}();
	var elements = A2($elm$core$List$concatMap, $author$project$Aoc15Element$toRowElements, rows);
	return A2(
		$elm$html$Html$table,
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Aoc15Element$UseInput),
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('radio'),
										$elm$html$Html$Events$onClick($author$project$Aoc15Element$UseSmaller),
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('radio'),
										$elm$html$Html$Events$onClick($author$project$Aoc15Element$UseLarger),
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('radio'),
										$elm$html$Html$Events$onClick($author$project$Aoc15Element$UseSituation),
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Aoc15Element$Clear)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$style, 'width', '80px'),
										$elm$html$Html$Events$onClick($author$project$Aoc15Element$Slower)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$style, 'width', '80px'),
										$elm$html$Html$Events$onClick($author$project$Aoc15Element$TogglePlay)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$style, 'width', '80px'),
										$elm$html$Html$Events$onClick($author$project$Aoc15Element$Faster)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$style, 'width', '80px'),
										$elm$html$Html$Events$onClick($author$project$Aoc15Element$Step)
									]),
								_List_fromArray(
									[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onClick($author$project$Aoc15Element$ToggleWide),
...
var $author$project$Aoc15Element$main = $elm$browser$Browser$element(
	{aE: $author$project$Aoc15Element$init, aK: $author$project$Aoc15Element$subscriptions, aM: $author$project$Aoc15Element$update, aN: $author$project$Aoc15Element$view});
_Platform_export({'Aoc15Element':{'init':$author$project$Aoc15Element$main(
